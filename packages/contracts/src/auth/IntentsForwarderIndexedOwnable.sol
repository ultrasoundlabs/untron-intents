...
/// @notice Fork of Solady's Ownable to work with IntentsForwarder's event chain index.
...
abstract contract IntentsForwarderIndexedOwnable is IntentsForwarderIndex {
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*                       CUSTOM ERRORS                        */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
