...
export const Endpoint = {
  ...
  fromJSON(object: any): Endpoint {
    return {
      ...
      addressIpv6: isSet(object.addressIpv6)
        ? Buffer.from(bytesFromBase64(object.addressIpv6))
        : Buffer.alloc(0),
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PingMessage>, I>>(object: I): PingMessage {
    ...
    message.from =
      object.from !== undefined && object.from !== null
        ...
        : undefined;
    message.to =
      object.to !== undefined && object.to !== null ? Endpoint.fromPartial(object.to) : undefined;
  ...
  fromJSON(object: any): FindNeighbours {
    return {
      ...
      targetId: isSet(object.targetId)
        ? Buffer.from(bytesFromBase64(object.targetId))
        : Buffer.alloc(0),
      timestamp: isSet(object.timestamp) ? Long.fromValue(object.timestamp) : Long.ZERO,
    };
  },
