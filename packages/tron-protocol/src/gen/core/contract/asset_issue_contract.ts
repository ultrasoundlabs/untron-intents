...
export const AssetIssueContract = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.frozenSupply.push(
            AssetIssueContract_FrozenSupply.decode(reader, reader.uint32())
          );
          continue;
        case 6:
          if (tag !== 48) {
  ...
  fromJSON(object: any): AssetIssueContract {
    return {
      ...
      description: isSet(object.description)
        ? Buffer.from(bytesFromBase64(object.description))
        : Buffer.alloc(0),
      url: isSet(object.url) ? Buffer.from(bytesFromBase64(object.url)) : Buffer.alloc(0),
      freeAssetNetLimit: isSet(object.freeAssetNetLimit)
  ...
  fromPartial<I extends Exact<DeepPartial<AssetIssueContract>, I>>(object: I): AssetIssueContract {
    ...
    message.frozenSupply =
      object.frozenSupply?.map((e) => AssetIssueContract_FrozenSupply.fromPartial(e)) || [];
    ...
    message.freeAssetNetLimit =
      object.freeAssetNetLimit !== undefined && object.freeAssetNetLimit !== null
        ? Long.fromValue(object.freeAssetNetLimit)
        : Long.ZERO;
...
export const AssetIssueContract_FrozenSupply = {
  encode(
    message: AssetIssueContract_FrozenSupply,
  ...
  create<I extends Exact<DeepPartial<AssetIssueContract_FrozenSupply>, I>>(
    base?: I
  ...
  fromPartial<I extends Exact<DeepPartial<AssetIssueContract_FrozenSupply>, I>>(
    ...
    message.frozenAmount =
      object.frozenAmount !== undefined && object.frozenAmount !== null
        ? Long.fromValue(object.frozenAmount)
        : Long.ZERO;
    message.frozenDays =
      object.frozenDays !== undefined && object.frozenDays !== null
...
export const TransferAssetContract = {
  ...
  fromJSON(object: any): TransferAssetContract {
    return {
      assetName: isSet(object.assetName)
        ? Buffer.from(bytesFromBase64(object.assetName))
        : Buffer.alloc(0),
      ownerAddress: isSet(object.ownerAddress)
        ? Buffer.from(bytesFromBase64(object.ownerAddress))
        : Buffer.alloc(0),
  ...
  fromPartial<I extends Exact<DeepPartial<TransferAssetContract>, I>>(
    object: I
...
export const UnfreezeAssetContract = {
  ...
  fromPartial<I extends Exact<DeepPartial<UnfreezeAssetContract>, I>>(
    object: I
...
export const UpdateAssetContract = {
  ...
  fromJSON(object: any): UpdateAssetContract {
    return {
      ...
      newPublicLimit: isSet(object.newPublicLimit)
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateAssetContract>, I>>(
    object: I
  ): UpdateAssetContract {
    const message = createBaseUpdateAssetContract();
    message.ownerAddress = object.ownerAddress ?? Buffer.alloc(0);
    ...
    message.url = object.url ?? Buffer.alloc(0);
    message.newLimit =
      object.newLimit !== undefined && object.newLimit !== null
        ? Long.fromValue(object.newLimit)
        : Long.ZERO;
    message.newPublicLimit =
      object.newPublicLimit !== undefined && object.newPublicLimit !== null
        ? Long.fromValue(object.newPublicLimit)
        : Long.ZERO;
    return message;
  },
...
export const ParticipateAssetIssueContract = {
  ...
  create<I extends Exact<DeepPartial<ParticipateAssetIssueContract>, I>>(
    base?: I
