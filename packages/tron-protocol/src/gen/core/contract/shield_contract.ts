...
export const MerklePath = {
  ...
  fromJSON(object: any): MerklePath {
    return {
      ...
      index: globalThis.Array.isArray(object?.index)
        ? object.index.map((e: any) => globalThis.Boolean(e))
        : [],
  ...
  toJSON(message: MerklePath): unknown {
    ...
    if (message.authenticationPaths?.length) {
      obj.authenticationPaths = message.authenticationPaths.map((e) =>
        AuthenticationPath.toJSON(e)
      );
    }
  ...
  fromPartial<I extends Exact<DeepPartial<MerklePath>, I>>(object: I): MerklePath {
    const message = createBaseMerklePath();
    message.authenticationPaths =
      object.authenticationPaths?.map((e) => AuthenticationPath.fromPartial(e)) || [];
...
export const IncrementalMerkleTree = {
  ...
  fromPartial<I extends Exact<DeepPartial<IncrementalMerkleTree>, I>>(
    object: I
...
export const IncrementalMerkleVoucher = {
  ...
  fromJSON(object: any): IncrementalMerkleVoucher {
    return {
      ...
      filled: globalThis.Array.isArray(object?.filled)
        ? object.filled.map((e: any) => PedersenHash.fromJSON(e))
        : [],
  ...
  create<I extends Exact<DeepPartial<IncrementalMerkleVoucher>, I>>(
    base?: I
  ): IncrementalMerkleVoucher {
    return IncrementalMerkleVoucher.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IncrementalMerkleVoucher>, I>>(
    object: I
  ): IncrementalMerkleVoucher {
    const message = createBaseIncrementalMerkleVoucher();
    message.tree =
    ...
    message.cursor =
      object.cursor !== undefined && object.cursor !== null
        ...
        : undefined;
    message.cursorDepth =
      object.cursorDepth !== undefined && object.cursorDepth !== null
        ? Long.fromValue(object.cursorDepth)
        : Long.ZERO;
    message.rt = object.rt ?? Buffer.alloc(0);
    message.outputPoint =
      object.outputPoint !== undefined && object.outputPoint !== null
...
export const IncrementalMerkleVoucherInfo = {
  ...
  create<I extends Exact<DeepPartial<IncrementalMerkleVoucherInfo>, I>>(
    base?: I
  ): IncrementalMerkleVoucherInfo {
    return IncrementalMerkleVoucherInfo.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<IncrementalMerkleVoucherInfo>, I>>(
    object: I
  ): IncrementalMerkleVoucherInfo {
    const message = createBaseIncrementalMerkleVoucherInfo();
  ...
  fromJSON(object: any): SpendDescription {
    return {
      ...
      nullifier: isSet(object.nullifier)
        ? Buffer.from(bytesFromBase64(object.nullifier))
        : Buffer.alloc(0),
      rk: isSet(object.rk) ? Buffer.from(bytesFromBase64(object.rk)) : Buffer.alloc(0),
      zkproof: isSet(object.zkproof)
        ? Buffer.from(bytesFromBase64(object.zkproof))
        : Buffer.alloc(0),
...
export const ShieldedTransferContract = {
  ...
  create<I extends Exact<DeepPartial<ShieldedTransferContract>, I>>(
    base?: I
  ): ShieldedTransferContract {
    return ShieldedTransferContract.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ShieldedTransferContract>, I>>(
    object: I
  ): ShieldedTransferContract {
    const message = createBaseShieldedTransferContract();
