...
export function smartContract_ABI_Entry_EntryTypeFromJSON(
  object: any
...
export function smartContract_ABI_Entry_EntryTypeToJSON(
  object: SmartContract_ABI_Entry_EntryType
): string {
  switch (object) {
...
export const SmartContract = {
  ...
  fromJSON(object: any): SmartContract {
    return {
      originAddress: isSet(object.originAddress)
        ? Buffer.from(bytesFromBase64(object.originAddress))
        : Buffer.alloc(0),
      ...
      bytecode: isSet(object.bytecode)
        ? Buffer.from(bytesFromBase64(object.bytecode))
        : Buffer.alloc(0),
      ...
      originEnergyLimit: isSet(object.originEnergyLimit)
        ? Long.fromValue(object.originEnergyLimit)
        : Long.ZERO,
      codeHash: isSet(object.codeHash)
        ? Buffer.from(bytesFromBase64(object.codeHash))
        : Buffer.alloc(0),
      trxHash: isSet(object.trxHash)
        ? Buffer.from(bytesFromBase64(object.trxHash))
        : Buffer.alloc(0),
  ...
  fromPartial<I extends Exact<DeepPartial<SmartContract>, I>>(object: I): SmartContract {
    ...
    message.abi =
      object.abi !== undefined && object.abi !== null
    ...
    message.originEnergyLimit =
      object.originEnergyLimit !== undefined && object.originEnergyLimit !== null
        ? Long.fromValue(object.originEnergyLimit)
        : Long.ZERO;
...
export const SmartContract_ABI_Entry = {
  ...
  toJSON(message: SmartContract_ABI_Entry): unknown {
    ...
    if (message.stateMutability !== 0) {
      obj.stateMutability = smartContract_ABI_Entry_StateMutabilityTypeToJSON(
  ...
  create<I extends Exact<DeepPartial<SmartContract_ABI_Entry>, I>>(
    base?: I
  ): SmartContract_ABI_Entry {
    return SmartContract_ABI_Entry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SmartContract_ABI_Entry>, I>>(
    object: I
  ): SmartContract_ABI_Entry {
    const message = createBaseSmartContract_ABI_Entry();
    ...
    message.outputs =
      object.outputs?.map((e) => SmartContract_ABI_Entry_Param.fromPartial(e)) || [];
...
export const SmartContract_ABI_Entry_Param = {
  encode(
    message: SmartContract_ABI_Entry_Param,
  ...
  create<I extends Exact<DeepPartial<SmartContract_ABI_Entry_Param>, I>>(
    base?: I
...
function createBaseContractState(): ContractState {
  return {
    ...
    energyFactor: Long.ZERO,
    updateCycle: Long.ZERO,
    _unknownFields: {},
  };
}
  ...
  fromPartial<I extends Exact<DeepPartial<ContractState>, I>>(object: I): ContractState {
    ...
    message.energyUsage =
      object.energyUsage !== undefined && object.energyUsage !== null
        ...
        : Long.ZERO;
    message.energyFactor =
      object.energyFactor !== undefined && object.energyFactor !== null
        ? Long.fromValue(object.energyFactor)
        : Long.ZERO;
    message.updateCycle =
      object.updateCycle !== undefined && object.updateCycle !== null
...
export const CreateSmartContract = {
  ...
  fromJSON(object: any): CreateSmartContract {
    return {
      ownerAddress: isSet(object.ownerAddress)
        ...
        : Buffer.alloc(0),
      newContract: isSet(object.newContract)
        ? SmartContract.fromJSON(object.newContract)
        : undefined,
      callTokenValue: isSet(object.callTokenValue)
  ...
  fromPartial<I extends Exact<DeepPartial<CreateSmartContract>, I>>(
    object: I
  ): CreateSmartContract {
    const message = createBaseCreateSmartContract();
    message.ownerAddress = object.ownerAddress ?? Buffer.alloc(0);
    message.newContract =
      object.newContract !== undefined && object.newContract !== null
        ? SmartContract.fromPartial(object.newContract)
        : undefined;
    message.callTokenValue =
      object.callTokenValue !== undefined && object.callTokenValue !== null
        ? Long.fromValue(object.callTokenValue)
        : Long.ZERO;
    message.tokenId =
...
export const TriggerSmartContract = {
  ...
  fromPartial<I extends Exact<DeepPartial<TriggerSmartContract>, I>>(
    object: I
...
export const UpdateSettingContract = {
  ...
  fromPartial<I extends Exact<DeepPartial<UpdateSettingContract>, I>>(
    object: I
...
export const UpdateEnergyLimitContract = {
  ...
  create<I extends Exact<DeepPartial<UpdateEnergyLimitContract>, I>>(
    base?: I
  ): UpdateEnergyLimitContract {
    return UpdateEnergyLimitContract.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UpdateEnergyLimitContract>, I>>(
    object: I
  ): UpdateEnergyLimitContract {
    const message = createBaseUpdateEnergyLimitContract();
    message.ownerAddress = object.ownerAddress ?? Buffer.alloc(0);
...
export const SmartContractDataWrapper = {
  ...
  fromJSON(object: any): SmartContractDataWrapper {
    return {
      smartContract: isSet(object.smartContract)
        ? SmartContract.fromJSON(object.smartContract)
        : undefined,
      runtimecode: isSet(object.runtimecode)
        ? Buffer.from(bytesFromBase64(object.runtimecode))
        : Buffer.alloc(0),
      contractState: isSet(object.contractState)
        ? ContractState.fromJSON(object.contractState)
        : undefined,
    };
  },
  ...
  create<I extends Exact<DeepPartial<SmartContractDataWrapper>, I>>(
    base?: I
  ): SmartContractDataWrapper {
    return SmartContractDataWrapper.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SmartContractDataWrapper>, I>>(
    object: I
  ): SmartContractDataWrapper {
    const message = createBaseSmartContractDataWrapper();
