...
```solidity
interface UntronIntentsIndexedOwnable {
...
pub mod UntronIntentsIndexedOwnable {
    use super::*;
...
```*/
    ...
    ///Container for all the [`UntronIntentsIndexedOwnable`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum UntronIntentsIndexedOwnableCalls {
        #[allow(missing_docs)]
    ...
    impl UntronIntentsIndexedOwnableCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for UntronIntentsIndexedOwnableCalls {
        const NAME: &'static str = "UntronIntentsIndexedOwnableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<UntronIntentsIndexedOwnableCalls>] = &[
                {
                    fn eventChainTip(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<UntronIntentsIndexedOwnableCalls> {
                        <eventChainTipCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(UntronIntentsIndexedOwnableCalls::eventChainTip)
                    }
                    eventChainTip
                },
                {
                    fn renounceOwnership(
                        ...
                        <renounceOwnershipCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(UntronIntentsIndexedOwnableCalls::renounceOwnership)
                    }
                    renounceOwnership
                },
                {
                    fn owner(
                        ...
                        <ownerCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(UntronIntentsIndexedOwnableCalls::owner)
                    }
                    owner
                },
                {
                    fn eventSeq(
                        ...
                        <eventSeqCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(UntronIntentsIndexedOwnableCalls::eventSeq)
                    }
                    eventSeq
                },
                {
                    fn transferOwnership(
                        ...
                        <transferOwnershipCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(UntronIntentsIndexedOwnableCalls::transferOwnership)
                    }
                    transferOwnership
                },
            ];
    ...
    ///Container for all the [`UntronIntentsIndexedOwnable`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum UntronIntentsIndexedOwnableErrors {
        #[allow(missing_docs)]
    ...
    impl UntronIntentsIndexedOwnableErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for UntronIntentsIndexedOwnableErrors {
        const NAME: &'static str = "UntronIntentsIndexedOwnableErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<UntronIntentsIndexedOwnableErrors>] = &[
                {
                    fn AlreadyInitialized(
                        ...
                        <AlreadyInitialized as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(UntronIntentsIndexedOwnableErrors::AlreadyInitialized)
                    }
                    AlreadyInitialized
                },
                {
                    fn NewOwnerIsZeroAddress(
                        ...
                        <NewOwnerIsZeroAddress as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(
                                UntronIntentsIndexedOwnableErrors::NewOwnerIsZeroAddress,
                            )
                    }
                ...
                },
                {
                    fn Unauthorized(
                        ...
                        <Unauthorized as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(UntronIntentsIndexedOwnableErrors::Unauthorized)
                    }
                    Unauthorized
                },
            ];
    ...
    ///Container for all the [`UntronIntentsIndexedOwnable`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum UntronIntentsIndexedOwnableEvents {
        #[allow(missing_docs)]
    ...
    impl UntronIntentsIndexedOwnableEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for UntronIntentsIndexedOwnableEvents {
        const NAME: &'static str = "UntronIntentsIndexedOwnableEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for UntronIntentsIndexedOwnableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`UntronIntentsIndexedOwnable`](self) contract instance.

See the [wrapper's documentation](`UntronIntentsIndexedOwnableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> UntronIntentsIndexedOwnableInstance<P, N> {
        UntronIntentsIndexedOwnableInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<UntronIntentsIndexedOwnableInstance<P, N>>,
    > {
        UntronIntentsIndexedOwnableInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        UntronIntentsIndexedOwnableInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`UntronIntentsIndexedOwnable`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`UntronIntentsIndexedOwnable`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct UntronIntentsIndexedOwnableInstance<
        P,
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for UntronIntentsIndexedOwnableInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("UntronIntentsIndexedOwnableInstance")
                .field(&self.address)
                .finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<UntronIntentsIndexedOwnableInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> UntronIntentsIndexedOwnableInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> UntronIntentsIndexedOwnableInstance<P, N> {
            UntronIntentsIndexedOwnableInstance {
