...
// Yet unfinalized ERC-7683 with some modifications
...
interface IOriginSettler {
    ...
    function openFor(GaslessCrossChainOrder calldata order, bytes calldata signature, bytes calldata fillerData)
        external;
    ...
    function resolveFor(GaslessCrossChainOrder calldata order, bytes calldata fillerData)
        external
        view
    ...
    /// @param resolvedOrder hydrated order data including the inputs and outputs of the order
